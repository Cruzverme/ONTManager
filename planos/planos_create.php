            ...
            <div class="panel-body">
              <form role="form" action="../classes/cadastra_planos.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="radio">
                    <label>
                      <input type="radio" name="optionTipoVelocidade" id="optionsRadios1" value="RESID_??M" required>Residencial
                    </label>
                    <label>
                      <input type="radio" name="optionTipoVelocidade" id="optionsRadios1" value="CORPF_??M" >Corporativo
                    </label>
                    <label>
                      <input type="radio" name="optionTipoVelocidade" id="optionsRadios1" value="CORPL_??M" >Corporativo Light
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  <label>Velocidade de Download</label>
                  <input class="form-control" placeholder="Velocidade Download" 
                    name="velocidade_download" type="number" min=0 autofocus required>
                </div>

                <div class="form-group">
                  <label>Velocidade de Upload</label> 
                  <input class="form-control" placeholder="Velocidade Upload" 
