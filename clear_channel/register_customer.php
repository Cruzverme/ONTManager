        ...
        <div class="login-panel panel panel-default">
          ...
          <fieldset>
            <legend>Informações</legend>
              <p>
                  <?php echo "PORTA: $porta_selecionado | 
                                OLT: $device | 
                                FRAME: $frame | 
                                SLOT: $slot | 
                                PON: $pon | 
                ...
                <legend>Requisitos</legend>
                  ...
                  <?php
                    echo "<input type=hidden name=porta_atendimento value=$porta_selecionado>
                          ...
                          <input type=hidden name=gems class=gems  value='$gemsPort'>
                          <input type=hidden name=vas  class=vas value='$vasProfile'>
                          <input type=hidden name=line class=line  value='$lineProfile'>
                          <input type=hidden name=serv class=serv  value='$serviceProfile'>
                    ";
                  ?>
