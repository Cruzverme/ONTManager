...
if (!mysqli_connect_errno()) {
    ...
    if ($botao == 'remover') {
        ...
        $cadastrar_ip == 19 ? $permitir_cadastrar_ip = 1 : $permitir_cadastrar_ip = 0;

        $permitir_gerenciar_l2l = $gerenciar_l2l == 20 ? 1 : 0;
        ...
        if ($cadastrar) {
            ...
            transferir_celula = $permitir_transferencia_celula, gerenciar_l2l = $permitir_gerenciar_l2l
